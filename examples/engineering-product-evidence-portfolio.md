...
Electronics / Embedded Engineering
            ↓
HMI · Industrial PCs · Controls · Communication
            ↓
Product / System Architecture · Validation · Industrialization
            ↓
R&D Leadership · Supplier / Partner Governance
            ↓
Customer Projects · Key Accounts · Business Development
            ↓
Program / PMO · Agile / Hybrid Transformation
            ↓
...
### Soehnle Professional — R&D / Product Development context
...
### Schildknecht Elektronik — Hardware & Software Development foundation
**Role context:** hands-on hardware, firmware and software development.

**Technical context:** graphic displays, touch controllers, communication systems, fieldbus, telemetry, remote monitoring and industrial wireless.

**Public references**
- [Schildknecht Industrial Wireless](https://www.schildknecht.ag/produkte/industrial-wireless/)

### Solutronic Energy — Energy / Power Electronics context
**Technical context:** battery-management systems, inverter technology, energy storage, power electronics and technical service / tooling.
...
These examples demonstrate the **application environments** connected to my earlier industrial electronics, automation, mobile-machine and HMI work. They are shown as public product references, not as claims of sole product ownership.

| Application / product context | Engineering relevance |
|---|---|
| **Rosenbauer PANTHER** | special-purpose vehicle electronics, HMI / controls, mobile-machine environment, rugged industrial application |
| **GRIMME agricultural machinery** | mobile automation, steering / control functions, vehicle integration and fieldbus-oriented application context |
| **Bucher municipal vehicles / mobile machinery** | rugged HMI, controller integration, mobile automation and OEM delivery context |
| **SPM printing machinery** | industrial automation, machine control and customer-specific system integration |
| **Collaborative robotics / servo drives** | motion control, embedded drive technology, solution engineering and robotics integration |
| **Professional weighing / medical-adjacent products** | measurement, approvals, product quality and regulated development context |

### Public application links
- [Rosenbauer PANTHER](https://www.rosenbauer.com/en/int/rosenbauer-world/products/vehicles/airport-vehicles/panther)
- [GRIMME](https://www.grimme.com/)
- [Bucher Municipal](https://www.buchermunicipal.com/)
